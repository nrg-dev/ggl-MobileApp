...
public class EndPointMobileApp implements Filter {
	...
	@PostMapping("/mobileTempPubliTreecUnitSave")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public String mobileTempPubliTreecUnitSave(@RequestBody String publicData)throws JSONException
	{
		logger.info("----- Inside mobileTempPubliTreecUnitSave Method Calling ----");
		Gson gson = new Gson();
